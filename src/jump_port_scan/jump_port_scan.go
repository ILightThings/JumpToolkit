...
func main() {
	...
	portarg := parser.String("p", "ports", &argparse.Options{Required: false, Default: "", Help: "TCP ports to scan. Single port, range, comma seperated, if blank, use (29) common ports"})
