...
func TestParsePorts(t *testing.T) {
	...
	test1, err := inputparse.ParsePorts(singleport)
	if err != nil {
	...
	test2, err := inputparse.ParsePorts(multiport)
	if err != nil {
	...
	test3, err := inputparse.ParsePorts(portrange)
	if err != nil {
	...
	_, err = inputparse.ParsePorts(badTest)
	if err == nil {
